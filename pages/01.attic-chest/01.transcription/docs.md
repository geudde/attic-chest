...
<a name="missing"></a>
**Lacunae:** Not all the DRO scans are complete. Minor lacunae such as missing words or phrases are indicated by red ellipses, with a mouse-hover comment indicating the problem. Major lacunae such as missing pages are identified with a grey button.
...
In the absence of author lists, contributions have been sorted on the basis of incomplete internal evidence, and may need to be revised after closer examination of the Gell Collection.